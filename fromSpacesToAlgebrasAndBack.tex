 ...
 \begin{Definition}
  A \emph{simplicial object} $K$ in a category $\mathscr{C}$ %TODO nachschauen wie man hier Kategorie typsetted
 ...
 \begin{Definition}
  ...
  ${\lambda^j(x_0, \dotsc, x_{k+1} \coloneqq }$ %TODO fertig schreiben
