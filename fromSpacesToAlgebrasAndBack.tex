 ...
 \begin{Definition}
  ...
  \begin{itemize}
   ...
   as the cochain algebra morphisms induced by:
    ...
    \end{center}    
  \end{itemize}
  For a topological space $X$ we will write $A_{PL}(X) \coloneqq A_{PL}(S_*^{sing}(X))$
 \end{Definition}
 ...
 \begin{Theorem}
  ...
  There is a quasi isomorphism $$m_V \colon \Sullivan \to A_{PL}(| \langle \Sullivan \rangle |)$$.
 \end{Theorem}
