...
% einige Abkuerzungen
\newcommand{\Quaternions}{\mathbb{H}} % Quaternionen
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sullivanAlgebras.tex}
\newpage
\input{npCompleteProblems.tex}
\newpage
\input{fromSpacesToAlgebrasAndBack.tex}
\newpage
\input{NpHardProblemsTopology.tex}
\newpage
\input{appendix.tex}
